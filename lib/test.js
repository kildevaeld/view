...
class List extends collection_view_1.CollectionView {
    constructor() {
        super(...arguments);
        this.childView = class ChildView extends view_1.View {
            constructor() {
                super(...arguments);
                this.template = (data) => `${data.name}`;
            }
        };
        this.collection = collection_view_1.ArrayCollection([
...
], TestController.prototype, "view2", void 0);
